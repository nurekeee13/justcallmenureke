...
public class MyApplication {
    ...
    public void start(){
        ...
        System.out.println("================       Welcome To Our Computer Club!   =====================");
        System.out.println("============================================================================");
        System.out.println("\n");
        System.out.println("1) If you already have an account");
        ...
        while(true){
            ...
            System.out.println("1) If you want to book/reserve PC");
            System.out.println("2) If you want to book/reserve PS");
            System.out.println("3) If you want to buy Food");
            System.out.println("4) If you want to know account information");
            System.out.println("5) If you want add money to your balance");
    ...
    public int createClientMenu(){
        System.out.println("Please give some information about yourself");
    ...
    public void reservePcMenu(int id){
        try {
            ...
            while(option != 2 || option != 0) {
                System.out.println("1) If you want to see the available PC's list");
                System.out.println("2) If you want to reserve PC");
                System.out.println("3) If you want to see reserved PC's list");
                ...
                if (option == 1) {
                    ...
                    System.out.println("Enter id of PC");
    ...
    public void reservePsMenu(int id){
        try {
            int option = -1;
            while(option != 2 || option != 0) {
                System.out.println("1) If you want to see the available PlayStations list");
                System.out.println("2) If you want to reserve PlayStation");
                System.out.println("3) If you want to see reserved PlayStations list");
                System.out.println("0. If you want to exit");
                System.out.println("Enter the option: (0 - 3)");
                option = scanner.nextInt();
                scanner.nextLine();
                ...
                if (option == 1) {
                    ...
                    System.out.println("Enter id of PlayStation");
                    int curid = scanner.nextInt();
                    scanner.nextLine();
    ...
    public void buyFood(int id){
        try {
            ...
            while(option != 2 || option != 3 || option != 0) {
                System.out.println("1) If you want to see the drinks list");
                System.out.println("2) If you want to see the snacks list");
                System.out.println("3) If you want to buy");
                System.out.println("0. If you want to exit");
                System.out.println("Enter the option: (0 - 3)");
                option = scanner.nextInt();
                scanner.nextLine();
